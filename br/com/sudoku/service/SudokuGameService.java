...
public class SudokuGameService {
    ...
    public void startGame(List<Cell> initialCells) {
        ...
        game.setStatus(GameStatus.INCOMPLETE); // jogo iniciado, mas incompleto

    }
    // para ver o stus atual do jogo (read)
    ...
    private void updateGameStatus(){
        ...
        int filledCells = (int) cells.values().stream() // filtra as células preenchidas e conta
